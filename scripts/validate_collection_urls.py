...
INPUT_FILE = Path("01_RAW_DATA/extracted/collection_urls.csv")
VALID_FILE = Path("01_RAW_DATA/extracted/validated_collection_urls.csv")
INVALID_FILE = Path("01_RAW_DATA/extracted/invalid_collection_urls.csv")
...
with open(INPUT_FILE, "r", encoding="utf-8-sig", newline="") as f:
    ...
    for row in reader:
        ...
        if not url:
            ...
            elif not parsed.path.startswith("/collections/"):
                reason = "Not a collection URL"
...
print("COLLECTION URL VALIDATION")
print("-------------------------")
