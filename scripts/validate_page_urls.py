...
INPUT_FILE = Path("01_RAW_DATA/extracted/page_urls.csv")
VALID_FILE = Path("01_RAW_DATA/extracted/validated_page_urls.csv")
INVALID_FILE = Path("01_RAW_DATA/extracted/invalid_page_urls.csv")
...
with open(INPUT_FILE, "r", encoding="utf-8-sig", newline="") as f:
    ...
    for row in reader:
        ...
        if not url:
            ...
            elif not parsed.path.startswith("/pages/"):
                reason = "Not a page URL"
